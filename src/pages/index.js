      ...
      <div className="x-hidden relative">
        ...
        <div className="bg-gray">
          <div className="teamdiv" id="team">
            ...
            <p className="text-white opensans">
          ...
          <div className="contactdiv" id="contact">
            ...
            <div className="contactgrid">
              <div>
                <h4 className="monte text-white">
                  Got a project? Get in touch with us now!{" "}
                </h4>
                <ContactForm />
                <p className="internship">
                  Looking for an internship opportunity?{" "}
                  <Link href={"/"}>
                    <a className="text-blue-200 underline">Click Here</a>
                  </Link>{" "}
                  to register
                </p>
              </div>
