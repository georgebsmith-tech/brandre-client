    ...
    return (
        <div className='x-hidden relative'>
            <div className='absolute x-sides-0 y-sides-0 top5 z-most ml20'>
                ...
                <p className='f24 inter mt30 bold500 text-white lh32 e'>With our expertise, we fuel your social media and create apps that promote engaging experience for your business.</p>
            </div>
